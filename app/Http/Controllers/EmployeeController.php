...
class EmployeeController extends Controller
{
  ...
  public function update(Request $request, $id){
    ...
    return redirect() -> route("showEmployee", $id)
                      -> withSuccess("Employee " . $validateData["firstName"] . " " . $validateData["lastName"] . " correttamente aggiornato");
  }
  ...
  public function destroy($id){
    ...
    return redirect() -> route("home")
                      -> withSuccess("Employee " . $employee["firstName"] . " " . $employee["lastName"] . " correttamente eliminato");
  }
  ...
  public function store(Request $request){
    ...
    return redirect() -> route("home")
                      -> withSuccess("Employee " . $task["firstName"] . " " . $task["lastName"] . " correttamente aggiunto");
  }
}
